...
public class RegistrationForm extends AppCompatActivity {
    ...
    public static final String SEND_UDSIZE = "com.example.mcslecproject.SEND_UDSIZE";
            ...
            public void onClick(View v) {
                ...
                if(checkBoxATC.isChecked() == true) {
                    if(correct == 1){}
                        ...
                        db_helper.insertUD(new UserData("1", name, phonenum, email, password, DOB, strGender));
...
//            Toast.makeText(this, "no data", Toast.LENGTH_SHORT).show();
            ...
            while (cursor.moveToNext()) {
                ...
                UserData obj =  new UserData(cursor.getInt(0) + "", cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6));
                UDV.add(obj);
            }
            return 1;
        }
    ...
    public int validation() {
        ...
        if(TextUtils.isEmpty(Email.getText().toString().trim())){
            Email.setError("input your email adress");
            Email.requestFocus();
            return 1;
